...
public class MinecraftReleaseBuildTriggerPolicy extends BaseAsyncPolledBuildTrigger
{
    ...
    public MinecraftReleaseBuildTriggerPolicy(final BuildCustomizerFactory buildCustomizerFactory) {this.buildCustomizerFactory = buildCustomizerFactory;}
    ...
    public String triggerBuild(@Nullable final String previousValue, @NotNull final PolledTriggerContext context) throws BuildTriggerException
    {
        try(final CloseableHttpClient client = HttpClientBuilder.create().build()) {
            ...
            try(final CloseableHttpResponse response = client.execute(versionsGetRequest)) {
                ...
                final Date currentReleaseDate = previousValue != null ? getDateForRelease(manifest, previousValue) : Date.from(Instant.EPOCH);
